        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
              Welcome to ElderElevation, where we enhance the lives of seniors through tailored groups and activities.
              Join us in building a vibrant, supportive community for all. 
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
              At ElderElevation, we're dedicated to providing engaging experiences for our senior members. 
              Join us in creating meaningful connections and lifelong memories.
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
              At ElderElevation, our Care Services team is committed to ensuring the well-being and happiness of all our members. 
