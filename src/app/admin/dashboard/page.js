    ...
    <div id='features' className="pb-16">
      ...
      <main className="px-4 pt-3 pb-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <Link href={"/admin/dashboard/caregiverpieCharts"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            <Image
              src={pieImg}
              alt="Feature Image"
            ...
            />
            <div className="p-4">
              <h2 className="text-xl font-bold mb-2">Caregiver Pie Charts</h2>
              <p>Caregiver pie charts for accepted vs rejected caregivers and distribution of caregivers among users.</p>
            </div>
          </Link>
          <Link href={"/admin/dashboard/pieCharts"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            />
            <div className="p-4">
              <h2 className="text-xl font-bold mb-2">Group Pie Charts</h2>
              <p>Group pie charts for group status distibution and group memberships. </p>
            </div>
          </Link>
          <Link href={"/admin/dashboard/usersLineChart"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            />
            <div className="p-4">
              <h2 className="text-xl font-bold mb-2">Users Line Graphs</h2>
              <p className="text-gray-700">
                This is the users' line graph. It displays the registration of users against date joined.
              </p>
            </div>
          </Link>
          <Link href={"/admin/dashboard/groupSparkChart"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            />
            <div className="p-4">
              <h2 className="text-xl font-bold mb-2">Membership Bar Chart</h2>
              <p className="text-gray-700">
                Bar chart representing the number of users in the groups.
              </p>
            </div>
          </Link>
          <Link href={"/admin/dashboard/displayDetails/caregiversDisplay"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p>A table displaying caregiver details</p>
            </div>
          </Link>
          <Link href={"/admin/dashboard/displayDetails/groupsDisplay"} className="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p>A table displaying group details</p>
            </div>
          </Link>
